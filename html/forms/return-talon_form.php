...
<div class="row justify-content-center">
  <div class="find-form-wrapper bg-light mt-2">
    <h3 class="text-center mt-2 mb-3">Погасить талон(ы)</h3>
...
<!-- if user admin -->
      <?php if($role == 10){ ?>
        <div class="form-group pl-2 pr-2">
          <input type="text" id="date" name="returnDate" class="datepicker-here form-control form-control-sm" require readonly placeholder="Если дата выдачи меньше текущей">
          <hr>
        </div>
        <div class="form-group pl-2 pr-2">
...
<!--===============-->
      <div class="form-group pl-2 pr-2">
        <div class="row">
          <div class="col">
            <input type="submit" class="btn btn-success text-custom btn-block btn-sm" name='return_talon' value="Погасить талон(ы)" id="btn">
          </div>
          <div class="col text-right pl-ret-custom">
...
<?php
if ($_SERVER['REQUEST_METHOD'] == "POST" and isset($_POST['return_talon'])) {
    require_once "../php/return-talon.php";
}
?>