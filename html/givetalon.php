...
<main role="main" class="flex-shrink-0">
  <div class="container min-vh-100">
    ...
    <div class="justify-content-center table-responsive w-100">
      <table class="table table-responsive table-bordered table-sm table-hover text-center mt-3" style="font-size: 0.8rem;">
