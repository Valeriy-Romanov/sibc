    ...
    <div class="main">
        ...
        <div class="conteiner">
            ...
            <div class="conteiner-main">
                <div class="result">
                    <?php
                    if ($_SESSION['signInvoice']) {
                        echo "<fieldset id=\"light\"><table class=\"total-table\">
                                <caption id=\"total1\">Согласно документа \"" . $_SESSION['invoce'] . "\" клиенту (" . $_SESSION['clnt_name'] . ") было ВЫДАНО талонов - <u>" . $_SESSION['numberTotal'] . " шт</u> , из них:</caption>
                                    <tbody>
                                        <tr id=\"total1\">
                                            <td></td>
                                            <td>ДТ-10л</td>
                        ...
                        echo "<fieldset id=\"light\"><table class=\"total-table\">
                                <caption id=\"give1\">Осталось \"НА РУКАХ\" у клиента (" . $_SESSION['clnt_name'] . "): <u>" . $_SESSION['number_1'] . " шт</u> талонов, из них:</caption>
                                <tbody>
                                    <tr id=\"give1\">
                                        <td></td>
                                        <td>ДТ-10л</td>
                    ...
                    if ($_SESSION['allTime']) {
                        echo "<fieldset id=\"light\"><table class=\"total-table\">
                                <caption id=\"total1\">За все время клиенту (" . $_SESSION['clnt_name'] . ") было ВЫДАНО талонов - <u>" . $_SESSION['numberTotal'] . " шт</u> , из них:</caption>
                                    <tbody>
                                        <tr id=\"total1\">
                                            <td></td>
                                            <td>ДТ-10л</td>
                        ...
                        echo "<fieldset id=\"light\"><table class=\"total-table\">
                                <caption id=\"total1\">Всего за период (" . $_SESSION['startDate'] . " : " . $_SESSION['finishDate'] . ")
                                    клиенту (" . $_SESSION['clnt_name'] . ") ВЫДАНО талонов - <u>" . $_SESSION['numberTotal'] . " шт</u> , из них:</caption>
                                    <tbody>
                                        <tr id=\"total1\">
                                            <td></td>
                                            <td>ДТ-10л</td>
                        ...
                        echo "<fieldset id=\"light\"><table class=\"total-table\">
                                <caption id=\"return1\">Всего за период (" . $_SESSION['startDate'] . " : " . $_SESSION['finishDate'] . ")
                                    клиентом (" . $_SESSION['clnt_name'] . ") ПОГАШЕНО талонов - <u>" . $_SESSION['number_0'] . " шт</u> , из них:</caption>
                                <tbody>
                                    <tr id=\"return1\">
                                        <td></td>
                                        <td>ДТ-10л</td>
                        ...
                        echo "<fieldset id=\"light\"><table class=\"total-table\">
                                <caption id=\"give1\">Осталось \"НА РУКАХ\" у клиента (" . $_SESSION['clnt_name'] . "): <u>" . $_SESSION['number_1'] . " шт</u> талонов, 
                                    выданных за период (" . $_SESSION['startDate'] . " : " . $_SESSION['finishDate'] . "), из них:</caption>
                                <tbody>
                                    <tr id=\"give1\">
                                        <td></td>
                                        <td>ДТ-10л</td>
